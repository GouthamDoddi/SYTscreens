                ...
                <View style={styles.weightrow}>
                  <View style={styles.weightsubrow}>
                    <View>
                      ...
                      <Text style={styles.avail2}>{data.package_weight}. KG</Text>
                    </View>
                    <View>
                      <Text style={styles.avail}>Package Space</Text>
                      <Text style={styles.avail2}>{data.package_space}. FT</Text>
                    </View>
                    <Text style={styles.avail3}>RS {data.package_space * 20}</Text>
                  </View>
                  <View style={styles.location}>
                    <View style={styles.locationsub}>
                      <Text style={styles.dropt3}>Drop Location</Text>
                      <Text style={styles.dropt}>{data.drop_point}</Text>
                      ...
                      <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={styles.dropt3}>{data.customer_mobile_num}</Text>
                      </View>
                    </View>
                    <View style={styles.locationsub}>
                      <Text style={styles.dropt3}>Pickup Location</Text>
                      <Text style={styles.dropt}>{data.pickup_point}</Text>
                      <Text style={styles.dropt3}>Receiving person Name</Text>
                      <Text style={styles.dropt}>{data.package_receiving_person}</Text>
                      <View style={{ flexDirection: 'row' }}>
                        <TouchableOpacity>
                          <Image
                            style={styles.droptimg}
                        ...
                        <Text style={styles.dropt3}>{data.receiving_person_mobile_no}</Text>
                      </View>
                    </View>
                  </View>
                  <View style={styles.delivery}>
                    ...
                    <TouchableOpacity style={styles.last} onPress={onSubmit}>
